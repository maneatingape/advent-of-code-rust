//! # Sonar Sweep
//!
//! The built-in [`array_windows`] method comes in handy for this solution. For part one a
//! straightforward sliding window of size 2 allows us to compare each 2 consecutive values.
//!
