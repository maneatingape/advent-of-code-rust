//! Provides fast [`HashSet`] and [`HashMap`] implementations based on a simplified implementation
//! of the fast [rustc hash algorithm](https://github.com/rust-lang/rustc-hash) also used by
...
//! resistant but slower hashing algorithm. [`FxHasher`] is much faster (between 2x and 5x from my
//! testing).
