...
//! spend a minimum mana on every turn, and that that the game will last for at least as many
...
//! that's okay: as long as the heuristic is consitent, underestimating is fine.
use crate::util::hash::*;
use crate::util::heap::*;
use crate::util::iter::*;
