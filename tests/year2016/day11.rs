...
The second floor contains a hydrogen generator and a elerium generator and a dilithium generator.
The third floor contains a hydrogen-compatible microchip and a elerium-compatible microchip and a dilithium-compatible microchip.
The fourth floor contains nothing relevant.";
